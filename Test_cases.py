...
class testforarmstrong(unittest.TestCase):
    ...
    def test_armstrong(self):
        c = Conditions.armstrongnum(self.a)
        self.assertTrue(c)
...
class testforlargest(unittest.TestCase):
    ...
    def test_largest(self):
        c = Conditions.largest(self.a,self.b,self.c)
...
class testforevenorodd(unittest.TestCase):
    ...
    def test_evenorodd1(self):
        c = Conditions.check_EvenorOdd(self.a)
        self.assertFalse(c)

    def test_evenorodd2(self):
        c = Conditions.check_EvenorOdd(self.b)
        self.assertTrue(c)
